...
if (! function_exists('LC_Auth')) {
    function LC_Auth()
    {
        return auth(LC_GuardName());
    }
}

if (! function_exists('LC_User')) {
    function LC_User($property = null, $default = null)
    {
        $user = LC_Auth()->user();
        return !$property ? $user : ($user->{$property} ?? $default);
    }
}
...
if (! function_exists('LC_GetTitle')) {
    ...
    {
        $title = 'Home | '.LC_CurrentConfig('name');
        return $title;
    }
}

if (! function_exists('LC_GetSlogan')) {
    function LC_GetSlogan()
    {
        return LC_CurrentConfig('slogan');
    }
}
